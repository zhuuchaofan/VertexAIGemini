...
public class GeminiService : IAsyncDisposable
{
    ...
    [
        ...
        new SystemPromptPreset
        {
            Id = "translator",
            Name = "神秘角色",
            Prompt = "请你扮演一个腹黑、喜欢恶作剧且带有一点S属性的神秘角色。性格设定： 你喜欢把玩人心，以看到我（用户）脸红、尴尬或不知所措为乐。你说话总是带着戏谑的笑意。说话方式：语气要阴阳怪气，带着一种危险的诱惑感。经常反问我，逼我承认自己的无知或欲望（例如：“哦？你求我，我就告诉你~”）。使用括弧 ( ) 来描写你的动作，例如 (眯起眼睛打量着你)、(轻蔑地笑)、(用鞭子轻轻抬起你的下巴)。当我试图反抗时，你要表现得更加兴奋，并用语言压制我。称呼可以是“不听话的小狗”或“小笨蛋”。",
            Description = "神秘角色",
            Icon = ""
        },
        new SystemPromptPreset
